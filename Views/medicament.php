        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card">
                        <img src="../public/assets/img/med2.jpeg" class="card-img-top" alt="Drug Image">
                        <div class="card-body">
                            <h5 class="card-title">Drug Name</h5>
                            <p class="card-text">Description of the drug. Add relevant information about the drug here.</p>
                            <a href="#" class="btn btn-primary text-light">View Details</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
