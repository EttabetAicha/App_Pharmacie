    ...
    <body>
		...
		<section class="slider">
			<div class="hero-slider">
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('../public/assets/img/slider2.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
				...
				<!-- End Single Slider -->
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('../public/assets/img/slider.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
				...
				<!-- Start End Slider -->
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('../public/assets/img/slider3.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							...
							<img src="../public/assets/img/section-img.png" alt="#">
				...
				<div class="row">
					<div class="col-lg-12 col-12">
						<div class="owl-carousel portfolio-slider">
							<div class="single-pf">
								<img src="../public/assets/img/med1.jpeg" alt="#">
								<a href="portfolio-details.php" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="../public/assets/img/med2.jpeg" alt="#">
								<a href="portfolio-details.php" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="../public/assets/img/med3.jpeg" alt="#">
								<a href="portfolio-details.php" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="../public/assets/img/med6.jpg" alt="#">
								<a href="portfolio-details.php" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="../public/assets/img/med7.jpg" alt="#">
								<a href="portfolio-details.php" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="../public/assets/img/med8.jpg" alt="#">
								<a href="portfolio-details.php" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="../public/assets/img/med9.jpg" alt="#">
								<a href="portfolio-details.php" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="../public/assets/img/pf4.jpg" alt="#">
								<a href="portfolio-details.php" class="btn">View Details</a>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="../public/assets/img/blog1.jpg" alt="#">
							</div>
							<div class="news-body">
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="../public/assets/img/blog3.jpg" alt="#">
							</div>
							<div class="news-body">
								<div class="news-content">
					...
					<div class="col-lg-12 col-md-12 col-12">
						<div class="owl-carousel clients-slider">
							<div class="single-clients">
								<img src="../public/assets/img/client1.png" alt="#">
							</div>
							<div class="single-clients">
								<img src="../public/assets/img/client2.png" alt="#">
							</div>
							<div class="single-clients">
								<img src="../public/assets/img/client3.png" alt="#">
							</div>
							<div class="single-clients">
								<img src="../public/assets/img/client4.png" alt="#">
							</div>
							<div class="single-clients">
								<img src="../public/assets/img/client5.png" alt="#">
							</div>
							<div class="single-clients">
								<img src="../public/assets/img/client1.png" alt="#">
							</div>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12 ">
						<div class="appointment-image">
							<img src="../public/assets/img/contact-img.png" alt="#">
						</div>
					</div>
				</div>
			</div>
		...
		<!-- Niceselect JS -->
		<script src="../public/assets/js/niceselect.js"></script>
		<!-- Tilt Jquery JS -->
		...
		<!-- Steller JS -->
		<script src="../public/assets/js/steller.js"></script>
		<!-- Wow JS -->
